...
\begin{tikzpicture}[xscale=1.5, yscale=1.2]
  ...
  \draw[thick, color=magenta!80!black] (-0.8,0.05) -- (0.1,0.05) to[out=0,in=180] (1.9,4.05) -- (6.1,4.05)
  to[out=0,in=180] (7.9,0.05) -- (8.8,0.05);
  \node[left, color=magenta!80!black, font=\normalsize] at (4.8, 4.3) {$f(t)+f(t-t_d)$};
  ...
  \node[right, color=green!50!black, font=\normalsize] at (5.0, 2.3) {$f(t-t_d)$};
  ...
  \node[left, color=brown!80!black, font=\normalsize] at (2.8, 2.3) {$f(t)$};

  % Dotted line additions
  \draw[dotted, thick] (2,0) -- (2,4);
  \node[below=10pt] at (2,0) {$t_r$};

  \draw[dotted, thick] (3,0) -- (3,4);
  \node[below=10pt] at (3,0) {$t_d$};
