...
a seed function, thereby enabling shorter gate durations.
% \subsection{X gate}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\columnwidth]{fig/fig_drag1.pdf}
  \caption{Creating a flat-top pulse using echo method}
  \label{fig:drag1}
\end{figure}
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\columnwidth]{fig/fig_drag2.pdf}
